...
## DEM Data
- **1979 & 1984 DEMs** – aerial photogrammetric DEMs (10 m resolution)  
- **2008 DEM** – ALOS World 3D (AW3D30) DSM, resampled to 10 m  
- **2023 DEM** – USGS 3DEP 1/3 arc-second DEM (~10 m)  
- 
## Input data
...
| 2023 | 2.589211 m  | 1.876958 m | +0.70 m | -6.83 m | -24.46 m   |
